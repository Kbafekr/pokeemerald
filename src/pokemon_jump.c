...
static const struct PokemonJumpMons sPokeJumpMons[] =
{
    ...
    { .species = SPECIES_TREECKO1,    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_TORCHIC1,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_MUDKIP1,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_MARSHTOMP1,  .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_POOCHYENA1,  .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_RALTS1,      .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_KIRLIA1,     .jumpType = JUMP_TYPE_NORMAL, },
    ...
    { .species = SPECIES_NUMEL1,      .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_TORKOAL1,    .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_SPOINK,     .jumpType = JUMP_TYPE_NORMAL, },
    { .species = SPECIES_TRAPINCH,   .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_TRAPINCH1,   .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_CACNEA,     .jumpType = JUMP_TYPE_SLOW, },
    { .species = SPECIES_ANORITH,    .jumpType = JUMP_TYPE_FAST, },
    { .species = SPECIES_ANORITH1,    .jumpType = JUMP_TYPE_FAST, },
    ...
    { .species = SPECIES_BAGON1,      .jumpType = JUMP_TYPE_FAST, },
};
