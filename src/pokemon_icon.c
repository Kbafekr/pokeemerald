...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_TREECKO1] = gMonIcon_Treecko1,
    [SPECIES_GROVYLE1] = gMonIcon_Grovyle1,
    [SPECIES_SCEPTILE1] = gMonIcon_Sceptile1,
    [SPECIES_TORCHIC1] = gMonIcon_Torchic1,
    [SPECIES_COMBUSKEN1] = gMonIcon_Combusken1,
    [SPECIES_BLAZIKEN1] = gMonIcon_Blaziken1,
    [SPECIES_MUDKIP1] = gMonIcon_Mudkip1,
    [SPECIES_MARSHTOMP1] = gMonIcon_Marshtomp1,
    [SPECIES_SWAMPERT1] = gMonIcon_Swampert1,
    [SPECIES_POOCHYENA1] = gMonIcon_Poochyena1,
    [SPECIES_MIGHTYENA1] = gMonIcon_Mightyena1,
    ...
    [SPECIES_TAILLOW1] = gMonIcon_Taillow1,
    [SPECIES_SWELLOW1] = gMonIcon_Swellow1,
    ...
    [SPECIES_TORKOAL1] = gMonIcon_Torkoal1,
    ...
    [SPECIES_FEEBAS1] = gMonIcon_Feebas1,
    [SPECIES_MILOTIC1] = gMonIcon_Milotic1,
    [SPECIES_CARVANHA1] = gMonIcon_Carvanha1,
    [SPECIES_SHARPEDO1] = gMonIcon_Sharpedo1,
    [SPECIES_TRAPINCH1] = gMonIcon_Trapinch1,
    [SPECIES_VIBRAVA1] = gMonIcon_Vibrava1,
    [SPECIES_FLYGON1] = gMonIcon_Flygon1,
    ...
    [SPECIES_ELECTRIKE1] = gMonIcon_Electrike1,
    [SPECIES_MANECTRIC1] = gMonIcon_Manectric1,
    [SPECIES_NUMEL1] = gMonIcon_Numel1,
    [SPECIES_CAMERUPT1] = gMonIcon_Camerupt1,
    ...
    [SPECIES_DUSKULL1] = gMonIcon_Duskull1,
    [SPECIES_DUSCLOPS1] = gMonIcon_Dusclops1,
    ...
    [SPECIES_SLAKOTH1] = gMonIcon_Slakoth1,
    [SPECIES_VIGOROTH1] = gMonIcon_Vigoroth1,
    [SPECIES_SLAKING1] = gMonIcon_Slaking1,
    ...
    [SPECIES_ABSOL1] = gMonIcon_Absol1,
    ...
    [SPECIES_ARON1] = gMonIcon_Aron1,
    [SPECIES_LAIRON1] = gMonIcon_Lairon1,
    [SPECIES_AGGRON1] = gMonIcon_Aggron1,
    ...
    [SPECIES_LILEEP1] = gMonIcon_Lileep1,
    [SPECIES_CRADILY1] = gMonIcon_Cradily1,
    [SPECIES_ANORITH1] = gMonIcon_Anorith1,
    [SPECIES_ARMALDO1] = gMonIcon_Armaldo1,
    ...
    [SPECIES_RALTS1] = gMonIcon_Ralts1,
    [SPECIES_KIRLIA1] = gMonIcon_Kirlia1,
    [SPECIES_GARDEVOIR1] = gMonIcon_Gardevoir1,
    [SPECIES_BAGON1] = gMonIcon_Bagon1,
    [SPECIES_SHELGON1] = gMonIcon_Shelgon1,
    [SPECIES_SALAMENCE1] = gMonIcon_Salamence1,
    [SPECIES_BELDUM1] = gMonIcon_Beldum1,
    [SPECIES_METANG1] = gMonIcon_Metang1,
    [SPECIES_METAGROSS1] = gMonIcon_Metagross1,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_SCEPTILE1] = 1,
    [SPECIES_TORCHIC1] = 0,
    [SPECIES_COMBUSKEN1] = 0,
    [SPECIES_BLAZIKEN1] = 0,
    [SPECIES_MUDKIP1] = 0,
    [SPECIES_MARSHTOMP1] = 0,
    [SPECIES_SWAMPERT1] = 0,
    [SPECIES_POOCHYENA1] = 2,
    [SPECIES_MIGHTYENA1] = 2,
    [SPECIES_ZIGZAGOON] = 2,
    [SPECIES_LINOONE] = 2,
    [SPECIES_WURMPLE] = 0,
    [SPECIES_SILCOON] = 2,
    ...
    [SPECIES_NUMEL] = 1,
    [SPECIES_CAMERUPT] = 0,
    [SPECIES_ELECTRIKE1] = 1,
    [SPECIES_MANECTRIC1] = 0,
    [SPECIES_NUMEL1] = 1,
    [SPECIES_CAMERUPT1] = 0,
    [SPECIES_SPHEAL] = 2,
    [SPECIES_SEALEO] = 2,
    ...
    [SPECIES_RALTS1] = 1,
    [SPECIES_KIRLIA1] = 1,
    [SPECIES_GARDEVOIR1] = 1,
    [SPECIES_BAGON1] = 2,
    [SPECIES_SHELGON1] = 2,
    [SPECIES_SALAMENCE1] = 0,
    [SPECIES_BELDUM1] = 0,
    [SPECIES_METANG1] = 0,
    [SPECIES_METAGROSS1] = 0,
    [SPECIES_RALTS] = 1,
    [SPECIES_KIRLIA] = 1,
    [SPECIES_GARDEVOIR] = 1,
    [SPECIES_BAGON] = 2,
