...
{
    [ITEM_ULTRA_BALL - ITEM_ULTRA_BALL]  = 80,
    [ITEM_GREAT_BALL - ITEM_ULTRA_BALL]  = 60,
    [ITEM_POKE_BALL - ITEM_ULTRA_BALL]   = 40,
    [ITEM_SAFARI_BALL - ITEM_ULTRA_BALL] = 60
};
    ...
    else
    {
        ...
        if (gLastUsedItem > ITEM_SAFARI_BALL)
        {
            ...
            case ITEM_TIMER_BALL:
                ballMultiplier = gBattleResults.battleTurnCounter + 40;
                break;
