const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CHANSEY]    = {{EVO_LEVEL, 37, SPECIES_BLISSEY}},
    ...
    [SPECIES_TREECKO1]    = {{EVO_LEVEL, 16, SPECIES_GROVYLE1}},
    [SPECIES_GROVYLE1]    = {{EVO_LEVEL, 36, SPECIES_SCEPTILE1}},
    [SPECIES_TORCHIC1]    = {{EVO_LEVEL, 16, SPECIES_COMBUSKEN1}},
    [SPECIES_COMBUSKEN1]  = {{EVO_LEVEL, 36, SPECIES_BLAZIKEN1}},
    [SPECIES_MUDKIP1]     = {{EVO_LEVEL, 16, SPECIES_MARSHTOMP1}},
    [SPECIES_MARSHTOMP1]  = {{EVO_LEVEL, 36, SPECIES_SWAMPERT1}},
    [SPECIES_POOCHYENA1]  = {{EVO_LEVEL, 18, SPECIES_MIGHTYENA1}},
    ...
    [SPECIES_TAILLOW1]    = {{EVO_LEVEL, 22, SPECIES_SWELLOW1}},
    ...
    [SPECIES_FEEBAS1]     = {{EVO_LEVEL, 20, SPECIES_MILOTIC1}},
    [SPECIES_CARVANHA1]   = {{EVO_LEVEL, 30, SPECIES_SHARPEDO1}},
    [SPECIES_TRAPINCH1]   = {{EVO_LEVEL, 35, SPECIES_VIBRAVA1}},
    [SPECIES_VIBRAVA1]    = {{EVO_LEVEL, 45, SPECIES_FLYGON1}},
    ...
    [SPECIES_ELECTRIKE1]  = {{EVO_LEVEL, 26, SPECIES_MANECTRIC1}},
    [SPECIES_NUMEL1]      = {{EVO_LEVEL, 33, SPECIES_CAMERUPT1}},
    ...
    [SPECIES_DUSKULL1]    = {{EVO_LEVEL, 37, SPECIES_DUSCLOPS1}},
    [SPECIES_SLAKOTH1]    = {{EVO_LEVEL, 18, SPECIES_VIGOROTH1}},
    [SPECIES_VIGOROTH1]   = {{EVO_LEVEL, 36, SPECIES_SLAKING1}},
    ...
    [SPECIES_ARON1]       = {{EVO_LEVEL, 32, SPECIES_LAIRON1}},
    [SPECIES_LAIRON1]     = {{EVO_LEVEL, 42, SPECIES_AGGRON1}},
    [SPECIES_LILEEP1]     = {{EVO_LEVEL, 40, SPECIES_CRADILY1}},
    [SPECIES_ANORITH1]    = {{EVO_LEVEL, 40, SPECIES_ARMALDO1}},
    [SPECIES_RALTS1]      = {{EVO_LEVEL, 20, SPECIES_KIRLIA1}},
    [SPECIES_KIRLIA1]     = {{EVO_LEVEL, 30, SPECIES_GARDEVOIR1}},
    [SPECIES_BAGON1]      = {{EVO_LEVEL, 30, SPECIES_SHELGON1}},
    [SPECIES_SHELGON1]    = {{EVO_LEVEL, 50, SPECIES_SALAMENCE1}},
    [SPECIES_BELDUM1]     = {{EVO_LEVEL, 20, SPECIES_METANG1}},
    [SPECIES_METANG1]     = {{EVO_LEVEL, 45, SPECIES_METAGROSS1}},
};
