const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_TREECKO1] = _("TREECKO"),
    [SPECIES_GROVYLE1] = _("GROVYLE"),
    [SPECIES_SCEPTILE1] = _("SCEPTILE"),
    [SPECIES_TORCHIC1] = _("TORCHIC"),
    [SPECIES_COMBUSKEN1] = _("COMBUSKEN"),
    [SPECIES_BLAZIKEN1] = _("BLAZIKEN"),
    [SPECIES_MUDKIP1] = _("MUDKIP"),
    [SPECIES_MARSHTOMP1] = _("MARSHTOMP"),
    [SPECIES_SWAMPERT1] = _("SWAMPERT"),
    [SPECIES_POOCHYENA1] = _("POOCHYENA"),
    [SPECIES_MIGHTYENA1] = _("MIGHTYENA"),
    ...
    [SPECIES_TAILLOW1] = _("TAILLOW"),
    [SPECIES_SWELLOW1] = _("SWELLOW"),
    ...
    [SPECIES_FEEBAS1] = _("FEEBAS"),
    [SPECIES_MILOTIC1] = _("MILOTIC"),
    [SPECIES_CARVANHA1] = _("CARVANHA"),
    [SPECIES_SHARPEDO1] = _("SHARPEDO"),
    [SPECIES_TRAPINCH1] = _("TRAPINCH"),
    [SPECIES_VIBRAVA1] = _("VIBRAVA"),
    [SPECIES_FLYGON1] = _("FLYGON"),
    ...
    [SPECIES_ELECTRIKE1] = _("ELECTRIKE"),
    [SPECIES_MANECTRIC1] = _("MANECTRIC"),
    [SPECIES_NUMEL1] = _("NUMEL"),
    [SPECIES_CAMERUPT1] = _("CAMERUPT"),
    ...
    [SPECIES_DUSKULL1] = _("DUSKULL"),
    [SPECIES_DUSCLOPS1] = _("DUSCLOPS"),
    [SPECIES_ROSELIA] = _("ROSELIA"),
    [SPECIES_SLAKOTH] = _("SLAKOTH"),
    [SPECIES_VIGOROTH] = _("VIGOROTH"),
    [SPECIES_SLAKING] = _("SLAKING"),
    [SPECIES_SLAKOTH1] = _("SLAKOTH"),
    [SPECIES_VIGOROTH1] = _("VIGOROTH"),
    [SPECIES_SLAKING1] = _("SLAKING"),
    ...
    [SPECIES_ARON1] = _("ARON"),
    [SPECIES_LAIRON1] = _("LAIRON"),
    [SPECIES_AGGRON1] = _("AGGRON"),
    ...
    [SPECIES_LILEEP1] = _("LILEEP"),
    [SPECIES_CRADILY1] = _("CRADILY"),
    [SPECIES_ANORITH1] = _("ANORITH"),
    [SPECIES_ARMALDO1] = _("ARMALDO"),
    [SPECIES_RALTS1] = _("RALTS"),
    [SPECIES_KIRLIA1] = _("KIRLIA"),
    [SPECIES_GARDEVOIR1] = _("GARDEVOIR"),
    [SPECIES_BAGON1] = _("BAGON"),
    [SPECIES_SHELGON1] = _("SHELGON"),
    [SPECIES_SALAMENCE1] = _("SALAMENCE"),
    [SPECIES_BELDUM1] = _("BELDUM"),
    [SPECIES_METANG1] = _("METANG"),
    [SPECIES_METAGROSS1] = _("METAGROSS"),
