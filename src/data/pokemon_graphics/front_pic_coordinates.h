...
const struct MonCoords gMonFrontPicCoords[] =
{
    ...
    [SPECIES_TREECKO1]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_GROVYLE1]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_SCEPTILE1]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_TORCHIC1]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    [SPECIES_COMBUSKEN1]   = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    [SPECIES_BLAZIKEN1]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_MUDKIP1]      = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 12 },
    [SPECIES_MARSHTOMP1]   = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_SWAMPERT1]    = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_POOCHYENA1]   = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    ...
    [SPECIES_TAILLOW1]     = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 16 },
    [SPECIES_SWELLOW1]     = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
    ...
    [SPECIES_TORKOAL1]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  2 },
    ...
    [SPECIES_FEEBAS1]      = { .size = MON_COORDS_SIZE(32, 48), .y_offset = 13 },
    [SPECIES_MILOTIC1]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CARVANHA1]    = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  6 },
    [SPECIES_SHARPEDO1]    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  3 },
    [SPECIES_TRAPINCH1]    = { .size = MON_COORDS_SIZE(40, 32), .y_offset = 16 },
    [SPECIES_VIBRAVA1]     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 12 },
    [SPECIES_FLYGON1]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  1 },
    ...
    [SPECIES_ELECTRIKE1]   = { .size = MON_COORDS_SIZE(48, 32), .y_offset = 18 },
    [SPECIES_MANECTRIC1]   = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  4 },
    [SPECIES_NUMEL1]       = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    [SPECIES_CAMERUPT1]    = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  9 },
    ...
    [SPECIES_DUSKULL1]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset = 10 },
    [SPECIES_DUSCLOPS1]    = { .size = MON_COORDS_SIZE(56, 56), .y_offset =  5 },
    ...
    [SPECIES_SLAKOTH1]     = { .size = MON_COORDS_SIZE(56, 32), .y_offset = 18 },
    [SPECIES_VIGOROTH1]    = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    ...
    [SPECIES_ABSOL1]       = { .size = MON_COORDS_SIZE(48, 64), .y_offset =  0 },
    ...
    [SPECIES_ARON1]        = { .size = MON_COORDS_SIZE(32, 24), .y_offset = 20 },
    [SPECIES_LAIRON1]      = { .size = MON_COORDS_SIZE(56, 40), .y_offset = 13 },
    [SPECIES_AGGRON1]      = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_LILEEP1]      = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_CRADILY1]     = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  0 },
    [SPECIES_ANORITH1]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  8 },
    [SPECIES_ARMALDO1]     = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_RALTS1]       = { .size = MON_COORDS_SIZE(24, 40), .y_offset = 15 },
    [SPECIES_KIRLIA1]      = { .size = MON_COORDS_SIZE(32, 56), .y_offset =  6 },
    [SPECIES_GARDEVOIR1]   = { .size = MON_COORDS_SIZE(56, 64), .y_offset =  1 },
    [SPECIES_BAGON1]       = { .size = MON_COORDS_SIZE(40, 48), .y_offset = 11 },
    [SPECIES_SHELGON1]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    [SPECIES_SALAMENCE1]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_BELDUM1]      = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 15 },
    [SPECIES_METANG1]      = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  7 },
    [SPECIES_METAGROSS1]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  6 },
