const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_TREECKO1] = gMonFootprint_Treecko,
    [SPECIES_GROVYLE1] = gMonFootprint_Grovyle,
    [SPECIES_SCEPTILE1] = gMonFootprint_Sceptile,
    [SPECIES_TORCHIC1] = gMonFootprint_Torchic,
    [SPECIES_COMBUSKEN1] = gMonFootprint_Combusken,
    [SPECIES_BLAZIKEN1] = gMonFootprint_Blaziken,
    [SPECIES_MUDKIP1] = gMonFootprint_Mudkip,
    [SPECIES_MARSHTOMP1] = gMonFootprint_Marshtomp,
    [SPECIES_SWAMPERT1] = gMonFootprint_Swampert,
    [SPECIES_POOCHYENA1] = gMonFootprint_Poochyena,
    [SPECIES_MIGHTYENA1] = gMonFootprint_Mightyena,
    ...
    [SPECIES_TAILLOW1] = gMonFootprint_Taillow,
    [SPECIES_SWELLOW1] = gMonFootprint_Swellow,
    ...
    [SPECIES_TORKOAL1] = gMonFootprint_Torkoal,
    ...
    [SPECIES_FEEBAS1] = gMonFootprint_Feebas,
    [SPECIES_MILOTIC1] = gMonFootprint_Milotic,
    [SPECIES_CARVANHA1] = gMonFootprint_Carvanha,
    [SPECIES_SHARPEDO1] = gMonFootprint_Sharpedo,
    [SPECIES_TRAPINCH1] = gMonFootprint_Trapinch,
    [SPECIES_VIBRAVA1] = gMonFootprint_Vibrava,
    [SPECIES_FLYGON1] = gMonFootprint_Flygon,
    ...
    [SPECIES_ELECTRIKE1] = gMonFootprint_Electrike,
    [SPECIES_MANECTRIC1] = gMonFootprint_Manectric,
    [SPECIES_NUMEL1] = gMonFootprint_Numel,
    [SPECIES_CAMERUPT1] = gMonFootprint_Camerupt,
    ...
    [SPECIES_DUSKULL1] = gMonFootprint_Duskull,
    [SPECIES_DUSCLOPS1] = gMonFootprint_Dusclops,
    ...
    [SPECIES_SLAKOTH1] = gMonFootprint_Slakoth,
    [SPECIES_VIGOROTH1] = gMonFootprint_Vigoroth,
    [SPECIES_SLAKING1] = gMonFootprint_Slaking,
    ...
    [SPECIES_ABSOL1] = gMonFootprint_Absol,
    ...
    [SPECIES_ARON1] = gMonFootprint_Aron,
    [SPECIES_LAIRON1] = gMonFootprint_Lairon,
    [SPECIES_AGGRON1] = gMonFootprint_Aggron,
    ...
    [SPECIES_LILEEP1] = gMonFootprint_Lileep,
    [SPECIES_CRADILY1] = gMonFootprint_Cradily,
    [SPECIES_ANORITH1] = gMonFootprint_Anorith,
    [SPECIES_ARMALDO1] = gMonFootprint_Armaldo,
    [SPECIES_RALTS1] = gMonFootprint_Ralts,
    [SPECIES_KIRLIA1] = gMonFootprint_Kirlia,
    [SPECIES_GARDEVOIR1] = gMonFootprint_Gardevoir,
    [SPECIES_BAGON1] = gMonFootprint_Bagon,
    [SPECIES_SHELGON1] = gMonFootprint_Shelgon,
    [SPECIES_SALAMENCE1] = gMonFootprint_Salamence,
    [SPECIES_BELDUM1] = gMonFootprint_Beldum,
    [SPECIES_METANG1] = gMonFootprint_Metang,
    [SPECIES_METAGROSS1] = gMonFootprint_Metagross,
