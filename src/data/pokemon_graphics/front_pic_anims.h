...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[] =
{
    ...
    [SPECIES_TREECKO1]     = sAnims_Treecko,
    [SPECIES_GROVYLE1]     = sAnims_Grovyle,
    [SPECIES_SCEPTILE1]    = sAnims_Sceptile,
    [SPECIES_TORCHIC1]     = sAnims_Torchic,
    [SPECIES_COMBUSKEN1]   = sAnims_Combusken,
    [SPECIES_BLAZIKEN1]    = sAnims_Blaziken,
    [SPECIES_MUDKIP1]      = sAnims_Mudkip,
    [SPECIES_MARSHTOMP1]   = sAnims_Marshtomp,
    [SPECIES_SWAMPERT1]    = sAnims_Swampert,
    [SPECIES_POOCHYENA1]   = sAnims_Poochyena,
    [SPECIES_MIGHTYENA1]   = sAnims_Mightyena,
    ...
    [SPECIES_TAILLOW1]     = sAnims_Taillow,
    [SPECIES_SWELLOW1]     = sAnims_Swellow,
    ...
    [SPECIES_TORKOAL1]     = sAnims_Torkoal,
    ...
    [SPECIES_FEEBAS1]      = sAnims_Feebas,
    [SPECIES_MILOTIC1]     = sAnims_Milotic,
    [SPECIES_CARVANHA1]    = sAnims_Carvanha,
    [SPECIES_SHARPEDO1]    = sAnims_Sharpedo,
    [SPECIES_TRAPINCH1]    = sAnims_Trapinch,
    [SPECIES_VIBRAVA1]     = sAnims_Vibrava,
    [SPECIES_FLYGON1]      = sAnims_Flygon,
    ...
    [SPECIES_ELECTRIKE1]   = sAnims_Electrike,
    [SPECIES_MANECTRIC1]   = sAnims_Manectric,
    [SPECIES_NUMEL1]       = sAnims_Numel,
    [SPECIES_CAMERUPT1]    = sAnims_Camerupt,
    ...
    [SPECIES_DUSKULL1]     = sAnims_Duskull,
    [SPECIES_DUSCLOPS1]    = sAnims_Dusclops,
    ...
    [SPECIES_SLAKOTH1]     = sAnims_Slakoth,
    [SPECIES_VIGOROTH1]    = sAnims_Vigoroth,
    [SPECIES_SLAKING1]     = sAnims_Slaking,
    ...
    [SPECIES_ARON1]        = sAnims_Aron,
    [SPECIES_LAIRON1]      = sAnims_Lairon,
    [SPECIES_AGGRON1]      = sAnims_Aggron,
    ...
    [SPECIES_LILEEP1]      = sAnims_Lileep,
    [SPECIES_CRADILY1]     = sAnims_Cradily,
    [SPECIES_ANORITH1]     = sAnims_Anorith,
    [SPECIES_ARMALDO1]     = sAnims_Armaldo,
    [SPECIES_RALTS1]       = sAnims_Ralts,
    [SPECIES_KIRLIA1]      = sAnims_Kirlia,
    [SPECIES_GARDEVOIR1]   = sAnims_Gardevoir,
    [SPECIES_BAGON1]       = sAnims_Bagon,
    [SPECIES_SHELGON1]     = sAnims_Shelgon,
    [SPECIES_SALAMENCE1]   = sAnims_Salamence,
    [SPECIES_BELDUM1]      = sAnims_Beldum,
    [SPECIES_METANG1]      = sAnims_Metang,
    [SPECIES_METAGROSS1]   = sAnims_Metagross,
