...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_TREECKO1]    = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_GROVYLE1]    = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_SCEPTILE1]   = BACK_ANIM_V_SHAKE,
    [SPECIES_TORCHIC1]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_COMBUSKEN1]  = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_BLAZIKEN1]   = BACK_ANIM_SHAKE_GLOW_RED,
    [SPECIES_MUDKIP1]     = BACK_ANIM_H_SLIDE,
    [SPECIES_MARSHTOMP1]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SWAMPERT1]   = BACK_ANIM_SHAKE_GLOW_BLUE,
    [SPECIES_POOCHYENA]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MIGHTYENA]  = BACK_ANIM_H_SHAKE,
    [SPECIES_POOCHYENA1]  = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_MIGHTYENA1]  = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_TAILLOW1]    = BACK_ANIM_CONCAVE_ARC_SMALL,
    [SPECIES_SWELLOW1]    = BACK_ANIM_JOLT_RIGHT,
    ...
    [SPECIES_TORKOAL1]    = BACK_ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_FEEBAS1]     = BACK_ANIM_H_SPRING,
    [SPECIES_MILOTIC1]    = BACK_ANIM_SHAKE_GLOW_BLUE,
    ...
    [SPECIES_CARVANHA1]   = BACK_ANIM_H_SPRING_REPEATED,
    [SPECIES_SHARPEDO1]   = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_TRAPINCH1]   = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_VIBRAVA1]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_FLYGON1]     = BACK_ANIM_TRIANGLE_DOWN,
    ...
    [SPECIES_ELECTRIKE1]  = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_MANECTRIC1]  = BACK_ANIM_V_SHAKE,
    [SPECIES_NUMEL1]      = BACK_ANIM_V_SHAKE_LOW,
    [SPECIES_CAMERUPT1]   = BACK_ANIM_SHAKE_GLOW_RED,
    ...
    [SPECIES_DUSKULL1]    = BACK_ANIM_H_VIBRATE,
    [SPECIES_DUSCLOPS1]   = BACK_ANIM_H_VIBRATE,
    ...
    [SPECIES_SLAKOTH1]    = BACK_ANIM_H_SLIDE,
    [SPECIES_VIGOROTH1]   = BACK_ANIM_CONCAVE_ARC_LARGE,
    [SPECIES_SLAKING1]    = BACK_ANIM_H_SHAKE,
    ...
    [SPECIES_ABSOL1]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    ...
    [SPECIES_ARON1]       = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_LAIRON1]     = BACK_ANIM_V_SHAKE,
    [SPECIES_AGGRON1]     = BACK_ANIM_V_SHAKE_LOW,
    ...
    [SPECIES_LILEEP1]     = BACK_ANIM_H_STRETCH,
    [SPECIES_CRADILY1]    = BACK_ANIM_V_STRETCH,
    [SPECIES_ANORITH1]    = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_ARMALDO1]    = BACK_ANIM_V_SHAKE,
    ...
    [SPECIES_RALTS1]      = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_KIRLIA1]     = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_GARDEVOIR1]  = BACK_ANIM_SHRINK_GROW_VIBRATE,
    [SPECIES_BAGON1]      = BACK_ANIM_V_SHAKE,
    [SPECIES_SHELGON1]    = BACK_ANIM_V_SHAKE,
    [SPECIES_SALAMENCE1]  = BACK_ANIM_H_SHAKE,
    [SPECIES_BELDUM1]     = BACK_ANIM_TRIANGLE_DOWN,
    [SPECIES_METANG1]     = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_METAGROSS1]  = BACK_ANIM_V_SHAKE,
