...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TREECKO1 - 1]     = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GROVYLE1 - 1]     = ANIM_V_STRETCH,
    [SPECIES_SCEPTILE1 - 1]    = ANIM_V_SHAKE,
    [SPECIES_TORCHIC1 - 1]     = ANIM_H_STRETCH,
    [SPECIES_COMBUSKEN1 - 1]   = ANIM_V_JUMPS_H_JUMPS,
    [SPECIES_BLAZIKEN1 - 1]    = ANIM_H_SHAKE,
    [SPECIES_MUDKIP1 - 1]      = ANIM_CIRCULAR_STRETCH_TWICE,
    [SPECIES_MARSHTOMP1 - 1]   = ANIM_V_SLIDE,
    [SPECIES_SWAMPERT1 - 1]    = ANIM_V_JUMPS_BIG,
    [SPECIES_POOCHYENA1 - 1]   = ANIM_V_SHAKE,
    [SPECIES_MIGHTYENA1 - 1]   = ANIM_V_SHAKE,
    ...
    [SPECIES_TAILLOW1 - 1]     = ANIM_V_JUMPS_BIG,
    [SPECIES_SWELLOW1 - 1]     = ANIM_CIRCULAR_STRETCH_TWICE,
    ...
    [SPECIES_TORKOAL1 - 1]     = ANIM_V_STRETCH,
    ...
    [SPECIES_FEEBAS1 - 1]      = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_MILOTIC1 - 1]     = ANIM_GLOW_BLUE,
    [SPECIES_CARVANHA1 - 1]    = ANIM_BOUNCE_ROTATE_TO_SIDES_SLOW,
    [SPECIES_SHARPEDO1 - 1]    = ANIM_H_JUMPS_V_STRETCH_TWICE,
    [SPECIES_TRAPINCH1 - 1]    = ANIM_V_SHAKE,
    [SPECIES_VIBRAVA1 - 1]     = ANIM_H_SHAKE,
    [SPECIES_FLYGON1 - 1]      = ANIM_ZIGZAG_SLOW,
    ...
    [SPECIES_ELECTRIKE1 - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_MANECTRIC1 - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_NUMEL1 - 1]       = ANIM_V_SLIDE,
    [SPECIES_CAMERUPT1 - 1]    = ANIM_V_SHAKE,
    ...
    [SPECIES_DUSKULL1 - 1]     = ANIM_ZIGZAG_FAST,
    [SPECIES_DUSCLOPS1 - 1]    = ANIM_H_VIBRATE,
    ...
    [SPECIES_SLAKOTH1 - 1]     = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_VIGOROTH1 - 1]    = ANIM_H_JUMPS,
    [SPECIES_SLAKING1 - 1]     = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    ...
    [SPECIES_ABSOL1 - 1]       = ANIM_CIRCULAR_VIBRATE,
    ...
    [SPECIES_ARON1 - 1]        = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_LAIRON1 - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_AGGRON1 - 1]      = ANIM_V_SHAKE_TWICE,
    ...
    [SPECIES_LILEEP1 - 1]      = ANIM_V_STRETCH,
    [SPECIES_CRADILY1 - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_ANORITH1 - 1]     = ANIM_TWIST,
    [SPECIES_ARMALDO1 - 1]     = ANIM_V_SHAKE,
    [SPECIES_RALTS1 - 1]       = ANIM_V_SQUISH_AND_BOUNCE_SLOW,
    [SPECIES_KIRLIA1 - 1]      = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_GARDEVOIR1 - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_BAGON1 - 1]       = ANIM_V_SHAKE_TWICE,
    [SPECIES_SHELGON1 - 1]     = ANIM_V_SLIDE,
    [SPECIES_SALAMENCE1 - 1]   = ANIM_H_SHAKE,
    [SPECIES_BELDUM1 - 1]      = ANIM_H_SHAKE,
    [SPECIES_METANG1 - 1]      = ANIM_V_SLIDE,
    [SPECIES_METAGROSS1 - 1]   = ANIM_V_SHAKE,
